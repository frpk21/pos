...
admin.site.register(FacturasAdmin)
admin.site.register(FactpAdmin)
admin.site.register(FormasPagosAdmin)
admin.site.register(PagosCarteraAdmin)
admin.site.register(CierresAdmin)
admin.site.register(Cierres1Admin)
admin.site.register(GrabadosCierres1Admin)
admin.site.register(FormasPagosAdmin)
admin.site.register(ValesAdmin)
admin.site.register(PagosValesAdmin)